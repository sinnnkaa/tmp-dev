...
// DFL-декодирования, масштабирования под исходный кадр и фильтра «бокс целиком
// внутри кадра». Фильтр именно отбрасывает не поместившуюся рамку, а не
// обрезает её по границе: раньше он назывался здесь клиппингом, и по описанию
// выходило ровно наоборот.
